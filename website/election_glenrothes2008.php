...
function WriteIntro($isbyelection, $issues)
{
    ...
    if ($isbyelection)
    {
        ...
        print "<p>It has been built for the <b>Glenrothes byelection</b> on 6 November,   
            ...
            Comments to <u>team@publicwhip.org.uk</u> are encouraged.
            Download Glenrothes flier <a href=\"quiz/glenrothesflier.pdf\">from here</a>.</p>\n";
...
if (!$referrer)
    $referrer = mysql_escape_string($_SERVER["HTTP_USER_AGENT"]);
