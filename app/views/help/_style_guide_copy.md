...
This will help you make everything you write at the <%= inline_project_name %> easy to read and understand.
...
## Avoid duplication
Duplicate content confuses people and damages the credibility of <%= inline_project_name %> content.
