...
xml.publicwhip do
  @members.each do |member|
    memberinfo = { id: "uk.org.publicwhip/member/#{member.id}",
                   ...
                   public_whip_division_attendance: fraction_to_percentage_display_mp_info(member.person.attendance_fraction),
                   public_whip_rebellions: fraction_to_percentage_display_mp_info(member.person.rebellions_fraction) }
