...
describe "routing redirects", :type => :request do
  ...
  it do
    ...
    expect(response).to redirect_to "/members/representatives/warringah/tony_abbott/policies/1?display=motions"
  end
  ...
  it do
    ...
    expect(response).to redirect_to "/members/senate/tasmania/eric_abetz/votes"
  end
end
