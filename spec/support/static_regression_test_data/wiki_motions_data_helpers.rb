  ...
  def create_wiki_motions
    ...
    create(
      ...
      text_body: "--- DIVISION TITLE ---\n\nProhibition of Human Cloning for Reproduction
        and the Regulation of Human Embryo Research Amendment Bill 2006 - Consideration
        in Detail\n\n--- MOTION EFFECT ---\n\n@MP voted aye to make this vote pass\r\n@MP
        voted no to make this vote fail\r\n\r\nThis is some test text. I'd like to illustrate
        formatting like ''italics'' and the following points:\r\n\r\n* My first point
        is simple\r\n* But I do have other points to\r\n* And sometimes I do go on\r\n\r\nTo
        back up my arguments I ensure that I link to official sources like the [http://aph.gov.au
        APH Official website].\r\n\r\n@This is a comment, it shouldn't be displayed.\r\n\r\nThere
        are other points where footnotes[1] are more useful for saying[2] more about my
