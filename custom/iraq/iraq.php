...
<body>
<?php
# $Id: iraq.php,v 1.1 2004/01/17 18:50:04 frabcus Exp $
...
array('2002-11-25', '6', 'no', 'bad', '0', '0'),
array('2003-02-26', '97', 'aye', 'bad', '0', '5'),
array('2003-02-26', '96', 'no', 'bad', '0', '0'),
array('2003-03-18', '118', 'aye', 'bad', '1', '10'),
array('2003-03-18', '117', 'no', 'bad', '1', '5'),
array('2003-06-04', '217', 'no', 'bad', '0', '0'),
array('2003-07-16', '294', 'no', 'bad', '0', '0'),
array('2003-09-10', '307', 'no', 'bad', '0', '0'));
...
# Print out table
print "<h2 align=center>For War</h2><table align=center>\n";
# ... header
...
foreach (array_keys($mps) as $mp)
{
    ...
    if ($last_initial > $this_initial)
    {
        print "</table></td><td width=50% valign=top><h2 align=center>Against War</h2><table align=center>";
        print "<th>"; $i = 0; foreach ($issues as $key => $issue) { $i++; print "<td>$i</td>"; } print "</th>\n";
    }
