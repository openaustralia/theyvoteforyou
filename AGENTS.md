...
`application:cards:` (social sharing images, generated by `app/lib/card_screenshotter/`), `application:portraits:`
(mirrors MP portraits from openaustralia.org.au into `public/system/portraits/`, see ADR 0004),
`application:links_valid:`, `application:seed:` and `application:config:`.
