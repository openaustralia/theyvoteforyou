...
Rails.application.configure do
  ...
  # We're using the log level because we were running out of disk space on the
  # default root disk in production
  ...
  config.cache_store = :mem_cache_store, nil, { namespace: "publicwhip-staging" }
  ...
  config.action_mailer.default_url_options = {
    protocol: "https",
    host: "test.theyvoteforyou.org.au"
  }
  ...
  config.facebook_admins = ["100008526366720"]
end
